...
casper.test.begin('列表8.0广告', 7 , function suite(test) {
    ...
    casper.then(function() {
        ...
        if(list[0].title == 'feedAddP1'){
            ...
            url = "http://godman-qa.camera360.com/operating_cms/operation/build/index.html#/page_fpV8FpFeedV8?name=fpFeedV8&value=feed配置&type=3&appName=camera360&editType=edit&systemName=dispatcherSystem&&_k=7s0yer&groupId=" + list[0].group_id;
