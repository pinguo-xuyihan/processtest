...
casper.test.begin('列表8.0广告', 6 , function suite(test) {
    ...
    casper.start('http://godman-qa.camera360.com/operating_cms/#page_historicalRecordsSearchV8?name=historicalRecordsSearchV8&value=8.0广告列表&type=3&appName=camera360&editType=cope&systemName=dispatcherSystem', function() {
    ...
    casper.then(function() {
        ...
        if(list[0].title == 'fpBannerAddP1'){
            url = "http://godman-qa.camera360.com/operating_cms/operation/build/index.html#/page_fpV8FpBannerV8?name=fpBannerV8&value=首页Banner&type=3&appName=camera360&editType=copy&systemName=dispatcherSystem&&_k=s6k1o4&groupId=" + list[0].group_id;
